...
public class LoginActivity extends Activity implements View.OnClickListener {
    ...
    private EditText etName, etEmail, etUsernameSignup, etPasswordSignup, editText5, etcity, etoccupation, etage;
    ...
    private void initViewsAndVars() {
        ...
        etcity = initEditText(R.id.etcity);
...
//                        instance.onReceive(c, i);
                        Intent intent = new Intent(LoginActivity.this, MainActivity.class);
                        Bundle dataBundle = new Bundle();
                        dataBundle.putString("username", etUsernameSignup.getText().toString());
